...
abstract class Palette {
  ...
  static Color red2 = const Color(0xFFfc2b2b);
  static Color yellow = const Color(0xFFFEC85B);
  static Color blue = const Color(0xFF3d85cd);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  static Color primary = const Color(0xff4fcdd9); // 주색상
  static Color bodyText = const Color(0xFF868686); // 글자 색상
  static Color inputBg = const Color(0xFFFBFBFB); // 텍스트필드 배경 색상
  static Color inputBorder = const Color(0xFFcce0ff); // 텍스트필드 테두리 색상 Color(0xFFF3F2F2);
  static Color border = const Color(0xFFdadada);
  static Color text_black = const Color(0xFF202020);
}